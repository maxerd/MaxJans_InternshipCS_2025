...
% Parametric identificaiton using ssest (PEM)
sysID.par.CL.time.direct.raw  = ssest(sysID.CLdata.train.direct);
sysID.par.CL.time.direct.filt = ssest(sysID.CLdataFilt.train.direct);
...
G_yr_raw = ssest(sysID.CLdata.train.indirect1);

G_yr     = ssest(sysID.CLdataFilt.train.indirect1);

% figure(1);clf; compare(sysID.CLdata.valid.indirect1,G_yr_raw,1)
% figure(2);clf; compare(sysID.CLdataFilt.valid.indirect1,G_yr,1)
...
G_ur_raw = ssest(sysID.CLdata.train.indirect2);

G_ur     = ssest(sysID.CLdataFilt.train.indirect2);

% figure(1);clf; compare(sysID.CLdata.valid.indirect2,G_ur_raw)
% figure(2);clf; compare(sysID.CLdataFilt.valid.indirect2,G_ur)
...
G_du_raw   = ssest(sysID.CLdata.train.classic);

G_du   = ssest(sysID.CLdataFilt.train.classic);
...
% figure(1);clf; compare(sysID.CLdata.valid.classic,    sysID.par.CL.time.classic.raw)
% figure(2);clf; compare(sysID.CLdataFilt.valid.classic,sysID.par.CL.time.classic.filt)
...
% figure(1);clf; compare(sysID.CLdata.valid.direct,    sysID.par.CL.time.coprime.raw,1)
% figure(2);clf; compare(sysID.CLdataFilt.valid.direct,sysID.par.CL.time.coprime.filt,1)
...
sysID.par.CL.time.twostage.raw  = ssest(dataCL_direct_2s_raw);%tf(est_2s_raw.B,est_2s_raw.F,est_2s_raw.Ts);
sysID.par.CL.time.twostage.filt = ssest(dataCL_direct_2s);    %tf(est_2s.B,est_2s.F,est_2s.Ts);
...
figure(1);clf; compare(sysID.CLdata.valid.direct,    sysID.par.CL.time.twostage.raw,1)
figure(2);clf; compare(sysID.CLdataFilt.valid.direct,sysID.par.CL.time.twostage.filt,1)
...
CL_freqDat_trd_direct_filt = idfrd(squeeze(sysID.nonPar.CL.frfComp.trd.direct.filt.ResponseData(:,:,Nrem+1:end)),sysID.nonPar.CL.frfComp.trd.direct.filt.Frequency(Nrem+1:end,:),1);
CL_freqDat_lpm_direct_filt = idfrd(squeeze(sysID.nonPar.CL.frfComp.lpm.direct.filt.ResponseData(:,:,Nrem+1:end)),sysID.nonPar.CL.frfComp.lpm.direct.filt.Frequency(Nrem+1:end,:),1);

CL_freqDat_trd_classic_filt = idfrd(squeeze(sysID.nonPar.CL.frfComp.trd.classic.filt.ResponseData(:,:,Nrem+1:end)),sysID.nonPar.CL.frfComp.trd.classic.filt.Frequency(Nrem+1:end,:),1);
CL_freqDat_lpm_classic_filt = idfrd(squeeze(sysID.nonPar.CL.frfComp.lpm.classic.filt.ResponseData(:,:,Nrem+1:end)),sysID.nonPar.CL.frfComp.lpm.classic.filt.Frequency(Nrem+1:end,:),1);

CL_freqDat_trd_coprime_filt = idfrd(squeeze(sysID.nonPar.CL.frfComp.trd.coprime.filt.ResponseData(:,:,Nrem+1:end)),sysID.nonPar.CL.frfComp.trd.coprime.filt.Frequency(Nrem+1:end,:),1);
CL_freqDat_lpm_coprime_filt = idfrd(squeeze(sysID.nonPar.CL.frfComp.lpm.coprime.filt.ResponseData(:,:,Nrem+1:end)),sysID.nonPar.CL.frfComp.lpm.coprime.filt.Frequency(Nrem+1:end,:),1);

% Perform the identifications
sysID.par.OL.freq.trd.direct.prd.filt = ssest(CL_freqDat_trd_direct_filt);
sysID.par.OL.freq.lpm.direct.prd.filt = ssest(CL_freqDat_lpm_direct_filt);

sysID.par.OL.freq.trd.classic.prd.filt = ssest(CL_freqDat_trd_classic_filt);
sysID.par.OL.freq.lpm.classic.prd.filt = ssest(CL_freqDat_lpm_classic_filt);

sysID.par.OL.freq.trd.coprime.prd.filt = ssest(CL_freqDat_trd_coprime_filt);
sysID.par.OL.freq.lpm.coprime.prd.filt = ssest(CL_freqDat_lpm_coprime_filt);
