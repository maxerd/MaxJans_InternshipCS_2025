...
# ---------------------- Custom Callback ---------------------- #
# class RMSECallback():
#     def __init__(self, X_val, y_val, mean_y, std_y):
#         super().__init__()
#         self.X_val = X_val
#         self.y_val = y_val
#         self.mean_y = mean_y
...
#         # Denormalize
#         y_pred_denorm = y_pred.flatten() * self.std_y + self.mean_y
#         y_val_denorm = self.y_val.flatten() * self.std_y + self.mean_y
...
def train_model(file_path, save_path, seq_length=10, epochs=100):
    ...
    # rmse_callback = RMSECallback(X_val, y_val, mean_y, std_y)
